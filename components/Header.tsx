	...
	return (
		<header className="max-w-6xl mx-auto p-2">
			...
			<section className="flex items-center space-x-2 py-5">
				...
				<button className="hidden sm:inline-flex bg-blue-600 text-white px-5 md:px-10 py-2 border-2 border-blue-600">
					Search
				</button>
			...
			<section className="flex py-3 space-x-6 text-xs md:text-sm whitespace-nowrap justify-center px-6">
				...
				<p className="link hidden sm:inline-flex">Video Games</p>
				<p className="link hidden sm:inline-flex">Home & Garden</p>
				<p className="link hidden md:inline-flex">Health & Beauty</p>
				<p className="link hidden lg:inline-flex">Collectibles & Art</p>
				<p className="link hidden lg:inline-flex">Books</p>
				<p className="link hidden lg:inline-flex">Music</p>
				<p className="link hidden xl:inline-flex">Deals</p>
				<p className="link hidden xl:inline-flex">Other</p>
